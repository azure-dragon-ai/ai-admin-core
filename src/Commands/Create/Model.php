...
class Model extends AICommand
{
     ...
     * @var string
     */
    protected $signature = 'ai:make:model {module} {model} {--t= : the model of table name}';
     ...
     * @var string
     */
    protected $description = 'create ai module';
    ...
    public function handle()
    {
        ...
        $modelPath = AIAdmin::getModuleModelPath($this->argument('module'));
    ...
    {
        return trim(AIAdmin::getModuleModelNamespace($this->argument('module')), '\\');
    }
