...
use AI\Support\Module\Installer;
...
class AIAdmin
{
    ...
    {
        return self::makeDir(base_path(config('ai.module.root')).DIRECTORY_SEPARATOR);
    }
    ...
    {
        return config('ai.module.namespace').'\\';
    }
    ...
    {
        return config('ai.route.cache_path', base_path('bootstrap/ai') . DIRECTORY_SEPARATOR . 'admin_route_cache.php');
    }
}
