...
namespace AI\Support\Module\Driver;
...
class DatabaseDriver implements ModuleRepositoryInterface
{
    ...
    public function create(array $module): bool|int
    {
        ...
        return $this->model->save([
            ...
            'provider' => sprintf('\\%s%s', AIAdmin::getModuleNamespace($module['name']), ucfirst($module['name']).'ServiceProvider'),
        ]);
    }
    ...
    protected function createModuleModel(): Model
    {
        return new class () extends Model {
            ...
            public function __construct(array $attributes = [])
            {
                ...
                $this->table = Container::getInstance()->make('config')->get('ai.module.driver.table_name');
            }
        };
    }
}
